    ...
    return (
        <div className="fixed inset-x-0 bottom-0 z-50 p-4">
            <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 p-[1px] shadow-2xl">
                <div className="rounded-2xl bg-white dark:bg-gray-900 p-4 sm:p-5">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <div>
                                <p className="font-semibold text-gray-900 dark:text-white">Nous utilisons des cookies</p>
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                            <button
                                ...
                                className="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700"
                            >
                                Refuser
                            </button>
                            <button
