    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                {open && (
                    <div ref={listRef} className="absolute z-20 mt-1 w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-lg max-h-72 overflow-auto">
