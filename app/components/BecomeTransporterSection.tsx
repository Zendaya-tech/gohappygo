            ...
            <div className="bg-slate-950 rounded-3xl overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    <div className="p-12 text-white">
                        <h2 className="text-4xl font-bold mb-6">Devenez <span className="text-blue-600">HappyVoyageur</span> et donnez du bonheur à d'autres voyageurs</h2>
                        <p className="text-blue-100 mb-8">
                            {t('home.hostSection.description')}
                        </p>
                        <button className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-100" onClick={handleCtaClick}>
