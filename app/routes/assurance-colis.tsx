        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Assurance colis</h1>
                    <p className="text-gray-600 dark:text-gray-300 mb-8">Protégez vos envois grâce à notre couverture adaptée aux échanges entre particuliers.</p>

                    <div className="space-y-6">
                        <section className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6">
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Ce qui est couvert</h2>
                        ...
                        <section className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6">
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Exclusions</h2>
                            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
                        ...
                        <section className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6">
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Comment déclarer un sinistre</h2>
